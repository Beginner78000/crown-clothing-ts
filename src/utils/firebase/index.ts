...
export const addCollectionAndDocuments = async <T extends ObjectToAdd>(
  ...
  objectsToAdd: T[]
  // With async function we return a promess who has a value
  // But here we are not returning any value => <void>
): Promise<void> => {
...
// UserData it is what we get from the setDoc call
// and that we pass to userSnapshot 
